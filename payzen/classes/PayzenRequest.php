...
if (! class_exists('PayzenRequest', false)) {
    ...
    class PayzenRequest
    {
        ...
        {
            // Initialize encoding.
            $this->encoding = in_array(Tools::strtoupper($encoding), PayzenApi::$SUPPORTED_ENCODINGS) ?
        ...
        {
            $this->redirectEnabled = ($enabled && (! is_string($enabled) || Tools::strtolower($enabled) !== 'false'));
            return true;
        }
